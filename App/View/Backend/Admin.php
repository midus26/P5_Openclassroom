		...
		<table>
			...
			<tr>
				<?php if (isset($billet['CheminImage'])): ?>
					<td class="AdminImg"><img src="<?php echo $billet['CheminImage']; ?>" alt="<?php echo $billet['AltImage']; ?>" class="ImgArticle" /></td>
				<?php ;endif; ?>
		...
		<table>
			...
			<tr>
				<?php if (isset($event['CheminImage'])): ?>
					<td class="AdminImg"><img class="ImgArticle" src="<?php echo $event['CheminImage']; ?>" alt="<?php echo $event['AltImage']; ?>" /></td>
				<?php endif; ?>
		...
		<table>
			...
			<tr>
				<?php if (isset($histoire['CheminImage'])){ ?>
					<td class="AdminImg"><img src="<?php echo $histoire['CheminImage'] ?>" alt="<?php echo $histoire['AltImage'] ?>" class="ImgArticle" /></td>
				<?php } ?>
