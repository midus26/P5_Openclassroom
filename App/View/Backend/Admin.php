	...
	<section>
		...
		<article>
			...
			<table>
				...
				<tr>
					<td class="AdminImg"><figure><img src="<?php echo $billet['CheminImage']; ?>" alt="<?php echo $billet['AltImage']; ?>" class="ImgArticle" /></figure></td>
		...
		<article>
			...
			<table>
				...
				<tr>
					<td class="AdminImg"><figure><img class="ImgArticle" src="<?php echo $event['CheminImage']; ?>" alt="<?php echo $event['AltImage']; ?>" /></figure></td>
		...
		<article>
			...
			<table>
				...
				<tr>
					<td class="AdminImg"><figure><img src="<?php echo $histoire['CheminImage'] ?>" alt="<?php echo $histoire['AltImage'] ?>" class="ImgArticle" /></figure></td>
